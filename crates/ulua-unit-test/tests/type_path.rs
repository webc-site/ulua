...
mod type_path_append {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:43:append
...
mod type_path_push {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:89:push
...
mod type_path_pop {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:98:pop
...
mod type_path_empty_traversal {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:119:empty_traversal
...
mod type_path_table_property {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:124:table_property
...
mod type_path_class_property {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:133:class_property
...
mod type_path_metatables {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:232:metatable
...
mod type_path_bounds {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:289:bounds
  ...
  fn type_path_bounds() {
    use ulua_analysis::{
      enums::type_field::TypeField,
      functions::{
        get_mutable_type::get_mutable_type_id, traverse_for_type_type_path::traverse_for_type,
      },
    ...
    // free_type / upper
    {
      ...
      let mut arena = TypeArena::default();
      let ty = arena.fresh_type_not_null_builtin_types_scope(unsafe { &*builtins }, &mut scope);
      let ft = get_mutable_type_id::<FreeType>(ty).expect("fresh type is a FreeType");
...
mod type_path_indexers {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:321:indexers
...
mod type_path_negated {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:355:negated
...
mod type_path_variadic {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:374:variadic
...
mod type_path_arguments {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:393:arguments
...
mod type_path_returns {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:415:returns
...
mod type_path_tail {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:438:tail
  ...
  fn type_path_tail() {
    ...
    let pack = traverse_for_pack(root, &path, unsafe { &*builtins }, &mut arena);
    assert!(pack.is_some());
    assert_eq!(
      to_string_type_pack_id(pack.expect("pack is_some above")),
      "...boolean"
...
mod type_path_pack_slice_has_tail {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:469:pack_slice_has_tail
...
mod type_path_pack_slice_finite_pack {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:484:pack_slice_finite_pack
...
mod type_path_pack_slice_type {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:499:pack_slice_type
...
mod type_path_cycles_table_contains_itself {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:508:cycles
  ...
  fn type_path_cycles_table_contains_itself() {
    ...
    let tbl_mut = get_mutable_type_id::<TableType>(tbl).expect("tbl is a TableType");
...
mod type_path_step_limit {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:537:step_limit
  ...
  fn type_path_step_limit() {
    ...
    let mut arena = TypeArena::default();
    let traversed = traverse_for_type(root, &path, unsafe { &*builtins }, &mut arena);
    assert!(
      traversed.is_none(),
...
mod type_path_complex_chains {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:557:complex_chains
...
mod type_path_to_string_field {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:594:field
...
mod type_path_to_string_index {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:599:index
...
mod type_path_to_string_chain {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:604:chain
...
mod type_path_human_property_then_metatable_portion {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:609:human_property_then_metatable_portion
...
mod type_path_builder_empty_path {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:935:empty_path
...
mod type_path_builder_prop {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:941:prop
...
mod type_path_builder_read_prop {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:947:readProp
...
mod type_path_builder_write_prop {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:953:writeProp
...
mod type_path_builder_index {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:959:index
...
mod type_path_builder_fields {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:965:fields
...
mod type_path_builder_chained {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:979:chained
...
mod type_path_builder_pack_slice {
  //! Node: cxx:Test:Luau.UnitTest:tests/TypePath.test.cpp:988:pack_slice
