...
impl FeedbackVectorFixture {
  ...
  fn load(&mut self) -> *mut Proto {
    ...
    unsafe {
      ...
      assert!(res == 0 && ulua_vm::macros::lua_isfunction::lua_isfunction!(l, -1));

      let top = ulua_vm::macros::clvalue::clvalue!((*l).top.sub(1));
      (*top).inner.l.p
    }
  }
...
mod simple_call {
  //! Node: `cxx:Test:Luau.UnitTest:tests/FeedbackVector.test.cpp:101:simple_call`
...
mod simple_call_sealed {
  //! Node: `cxx:Test:Luau.UnitTest:tests/FeedbackVector.test.cpp:150:simple_call_sealed`
...
mod simple_call_sealed_on_inline {
  //! Node: `cxx:Test:Luau.UnitTest:tests/FeedbackVector.test.cpp:179:simple_call_sealed_on_inline`
...
mod high_order_call {
  //! Node: `cxx:Test:Luau.UnitTest:tests/FeedbackVector.test.cpp:205:high_order_call`
...
mod polymorphic_call_sealed {
  //! Node: `cxx:Test:Luau.UnitTest:tests/FeedbackVector.test.cpp:254:polymorphic_call_sealed`
...
mod c_call_sealed {
  //! Node: `cxx:Test:Luau.UnitTest:tests/FeedbackVector.test.cpp:281:c_call_sealed`
...
mod metamethod_call_sealed {
  //! Node: `cxx:Test:Luau.UnitTest:tests/FeedbackVector.test.cpp:308:metamethod_call_sealed`
...
mod namecall {
  //! Node: `cxx:Test:Luau.UnitTest:tests/FeedbackVector.test.cpp:340:namecall`
