...
mod subtyping_normalizer_try_normalize_returns_none_when_fuel_exhausted {
  ...
  fn subtyping_normalizer_try_normalize_returns_none_when_fuel_exhausted() {
    ...
    for _ in 0..8 {
      let next = fixture.fn_item_initializer_list_type_id_initializer_list_type_id(
        vec![string_ty],
        vec![number_ty],
      );
...
mod subtyping_normalizer_try_normalize_succeeds_within_fuel {
...
mod subtyping_semantic_subtyping_reports_normalization_too_complex {
...
mod subtyping_normalize_failure_reports_hit_limits {
