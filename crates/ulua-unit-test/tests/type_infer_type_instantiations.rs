...
fn type_infer_type_instantiations_function_intersections() {
  use ulua_analysis::{
    functions::to_string_error::to_string_type_error, type_aliases::type_error_data::TypeErrorData,
  };
  use ulua_common::fflag;
  use ulua_unit_test::{records::fixture::Fixture, type_aliases::scoped_fast_flag::ScopedFastFlag};
...
fn type_infer_type_instantiations_replacing_generic_with_generic() {
  ...
  assert_eq!(
    "string",
    to_string_type_id(fixture.require_type_string("baz"))
  );
  assert_eq!(
    "number",
    to_string_type_id(fixture.require_type_string("quxx"))
  );
}
