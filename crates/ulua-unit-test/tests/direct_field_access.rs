...
mod handler_setnumber_result {
  //! Node: `cxx:Test:Luau.UnitTest:tests/DirectFieldAccess.test.cpp:63:handler_setnumber_result`
...
mod handler_setboolean_result {
  //! Node: `cxx:Test:Luau.UnitTest:tests/DirectFieldAccess.test.cpp:93:handler_setboolean_result`
...
mod repeated_access_handler_called_every_iteration {
  //! Node: `cxx:Test:Luau.UnitTest:tests/DirectFieldAccess.test.cpp:133:repeated_access_handler_called_every_iteration`
...
mod unregistered_tag_falls_through_to_index_metamethod {
  //! Node: `cxx:Test:Luau.UnitTest:tests/DirectFieldAccess.test.cpp:170:unregistered_tag_falls_through_to_index_metamethod`
...
mod multiple_fields_same_type_dispatch_independently {
  //! Node: `cxx:Test:Luau.UnitTest:tests/DirectFieldAccess.test.cpp:226:multiple_fields_same_type_dispatch_independently`
...
mod same_field_name_different_tags_dispatch_independently {
  //! Node: `cxx:Test:Luau.UnitTest:tests/DirectFieldAccess.test.cpp:266:same_field_name_different_tags_dispatch_independently`
