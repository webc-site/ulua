...
mod ir_builder_dead_predecessor_does_not_prevent_tag_propagation {
  //! Source: `tests/IrBuilder.test.cpp`
  //! "DeadPredecessorDoesNotPreventTagPropagation" (line 4333).
  //! The C++ `LuauCodegenSkipDeadPredecessorTags` flag lives in the
  //! `ulua_code_gen::fflag` module instead of `ulua_common::FFlag`.
  ...
  fn ir_builder_dead_predecessor_does_not_prevent_tag_propagation() {
    ...
    let _luau_codegen_skip_dead_predecessor_tags =
      ScopedFastFlag::new(&LUAU_CODEGEN_SKIP_DEAD_PREDECESSOR_TAGS, true);
...
mod ir_builder_double_contraction_deduplication {
  ...
  fn ir_builder_double_contraction_deduplication() {
    ...
    let _luau_codegen_substitute_replacements =
      ScopedFastFlag::new(&LUAU_CODEGEN_SUBSTITUTE_REPLACEMENTS, true);
...
mod ir_builder_dse_vm_exit_sync_multi_use_chained_dependency_1 {
  //! Source: `tests/IrBuilder.test.cpp`
...
mod ir_builder_dse_vm_exit_sync_multi_use_chained_dependency_2 {
  //! Source: `tests/IrBuilder.test.cpp`
...
mod ir_builder_dse_vm_exit_sync_multi_use_sink {
...
mod ir_builder_fallback_clobber_does_not_propagate_overwritten_tag {
  //! Source: `tests/IrBuilder.test.cpp`
...
mod ir_builder_fallback_multiple_branch_points_from_same_block_intersect {
  //! Source: `tests/IrBuilder.test.cpp`
...
mod ir_builder_fallback_reached_by_folded_unconditional_jump {
  //! Source: `tests/IrBuilder.test.cpp`
...
mod ir_builder_float_contraction_deduplication {
...
mod ir_builder_float_simplifications {
...
mod ir_builder_integer_conversion_deduplication {
...
mod ir_builder_load_origin_no_redirect_after_captured_mutation {
  //! Source: `tests/IrBuilder.test.cpp`
...
mod ir_builder_no_linear_extraction_for_block_with_call {
...
mod ir_builder_no_linear_extraction_for_chain_with_call {
...
mod ir_builder_no_linear_extraction_for_chain_with_call_live_out {
  //! Source: `tests/IrBuilder.test.cpp`
...
mod ir_builder_tags_are_joined_from_fallback_predecessor {
...
mod ir_builder_tags_established_before_fallback_branch_propagate_through_merge {
  //! Source: `tests/IrBuilder.test.cpp`
