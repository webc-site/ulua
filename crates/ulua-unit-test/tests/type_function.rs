...
fn type_function_a_tf_parameterized_on_a_solved_tf_is_solved() {
  ...
  use ulua_analysis::{
    ...
    functions::{get_type, reduce_type_functions_type_function::reduce_type_functions},
  ...
  let _res = reduce_type_functions(outer_add_ty, Location::default(), &mut fixture.tfc, false);

  let tfit = get_type::get::<TypeFunctionInstanceType>(outer_add_ty)
...
fn type_function_a_type_function_parameterized_on_generics_is_solved() {
  ...
  let _res = reduce_type_functions(add_ty, Location::default(), &mut fixture.tfc, false);

  let tfit =
    get_type::get::<TypeFunctionInstanceType>(add_ty).expect("expected TypeFunctionInstanceType");
  assert_eq!(TypeFunctionInstanceState::Solved, tfit.state());
}
...
fn type_function_basic_type_function() {
  ...
  assert_eq!(
    "string",
    to_string_type_id(fixture.base.require_type_alias("A"))
  );
  assert_eq!(
    "number",
    to_string_type_id(fixture.base.require_type_alias("B"))
  );
  assert_eq!(
    "Swap<boolean>",
    to_string_type_id(fixture.base.require_type_alias("C"))
  );
  assert_eq!(
    "string",
...
fn type_function_binary_type_function_works_with_default_argument() {
  ...
  assert_eq!(
    "() -> number",
    to_string_type_id(fixture.base.base.require_type_string("thunk"))
  );
}
...
fn type_function_cyclic_add_function_at_work() {
  ...
  assert_eq!(
    "number",
    to_string_type_id(fixture.base.require_type_alias("T"))
  );
}
...
fn type_function_ensure_equivalence_with_distributivity() {
  ...
  assert_eq!(
    "A | A | B | B",
    to_string_type_id(fixture.base.require_type_alias("U"))
  );
}
...
fn type_function_function_as_fn_ret() {
  ...
  let a_ty = to_string_type_id(fixture.base.require_type_string("a"));
  let b_ty = to_string_type_id(fixture.base.require_type_string("b"));
  let c_ty = to_string_type_id(fixture.base.require_type_string("c"));
...
fn type_function_getmetatable_respects_metatable_metamethod() {
  ...
  assert_eq!(
    "string",
    to_string_type_id(fixture.base.require_type_alias("Metatable"))
  );
}
...
fn type_function_getmetatable_returns_correct_metatable() {
  ...
  assert_eq!(
    ...
    to_string_type_id_to_string_options_mut(
      fixture.base.require_type_alias("Metatable"),
...
fn type_function_getmetatable_returns_correct_metatable_for_string() {
  use ulua_analysis::{
    functions::{
      ...
      to_string_to_string::to_string_type_id_to_string_options_mut,
    },
    records::to_string_options::ToStringOptions,
  };
  use ulua_common::fflag;
  ...
  assert_eq!(
    expected,
    to_string_type_id_to_string_options_mut(
      fixture.base.require_type_alias("Metatable2"),
      ToStringOptions::new(true)
    )
  );
}
...
fn type_function_getmetatable_returns_correct_metatable_for_union() {
  ...
  assert_eq!(
    ...
    to_string_type_id_to_string_options_mut(
      fixture.base.require_type_alias("IntersectMetatable"),
      ToStringOptions::new(true)
    )
  );
}
...
fn type_function_getmetatable_type_function_returns_nil_if_no_metatable() {
  ...
  assert_eq!(
    "nil",
    to_string_type_id(fixture.base.require_type_alias("TableWithNoMetatable"))
  );
  assert_eq!(
    "nil",
    to_string_type_id(fixture.base.require_type_alias("NumberWithNoMetatable"))
  );
  assert_eq!(
    "nil",
    to_string_type_id(fixture.base.require_type_alias("BooleanWithNoMetatable"))
  );
  assert_eq!(
    "nil",
    to_string_type_id(
      fixture
        .base
        .require_type_alias("BooleanLiteralWithNoMetatable")
    )
  );
}
...
fn type_function_index_should_not_crash_on_cyclic_stuff() {
  ...
  assert_eq!(
    ...
    to_string_type_id(fixture.base.require_type_alias("Keys"))
  );
}
...
fn type_function_index_should_not_crash_on_cyclic_stuff_3() {
  // Upstream wraps this test in `#if 0` (CLI-148701, TypeFunction.test.cpp:953),
  // so the compiled C++ suite executes no body.
}
...
fn type_function_index_type_function_works_on_function_metamethods() {
  ...
  assert_eq!(
    "{ x: string }",
    to_string_type_id_to_string_options_mut(
      fixture.base.require_type_alias("Bar"),
      ToStringOptions::new(true)
    )
  );
}
...
fn type_function_keyof_should_not_assert_on_empty_string_props() {
  ...
  assert_eq!(
    "\"\" | \"one\"",
    to_string_type_id(fixture.base.require_type_alias("FoobarKeys"))
  );
  assert_eq!(
    "\"\" | \"two\"",
    to_string_type_id(fixture.base.require_type_alias("TableKeys"))
  );
}
...
fn type_function_keyof_single_entry_no_uniontype() {
  ...
  assert_eq!(
    "\"abc\"",
    to_string_type_id(fixture.base.require_type_alias("keyof_A"))
  );
  assert_eq!(
    "\"a1\" | \"a2\"",
    to_string_type_id(fixture.base.require_type_alias("keyof_B"))
  );
}
...
fn type_function_or_a_b() {
  ...
  let res = reduce_type_functions(or_type, Location::default(), &mut fixture.tfc, false);
...
fn type_function_oss_2106_wait_for_pending_types_in_setmetatable_ex_1() {
  ...
  assert_eq!(
    "string",
    to_string_type_id(fixture.base.require_type_string("g"))
  );
}
...
fn type_function_oss_2114_type_instantiation_on_type_function() {
  ...
  let _new_solver = ScopedFastFlag::new(&fflag::DebugLuauForceOldSolver, false);
  let _type_instantiation = ScopedFastFlag::new(&fflag::LuauExplicitTypeInstantiationSupport, true);
...
fn type_function_oss_2144_type_instantiation_on_type_function() {
  ...
  assert_eq!(
    "number",
    to_string_type_id(fixture.base.require_type_string("_b"))
  );
}
...
fn type_function_rawget_type_function_works_w_index_metatables() {
  ...
  assert_eq!(
    "nil",
    to_string_type_id(fixture.base.require_type_alias("nil_type"))
  );
  assert_eq!(
    "number?",
    to_string_type_id(fixture.base.require_type_alias("number_type"))
  );
}
...
fn type_function_rawget_type_function_works_w_union_type_indexer() {
  ...
  assert_eq!(
    "string?",
    to_string_type_id(fixture.base.require_type_alias("string_type"))
  );
}
...
fn type_function_reduce_cyclic_add() {
  ...
  let res = reduce_type_functions(root, Location::default(), &mut fixture.tfc, false);
...
fn type_function_reduce_degenerate_refinement() {
  ...
  let _res = reduce_type_functions(refinement, Location::default(), &mut fixture.tfc, true);
...
fn type_function_refine_g_false() {
  ...
  let res = reduce_type_functions(refine_ty, Location::default(), &mut fixture.tfc, false);
...
fn type_function_setmetatable_type_function_assigns_correct_metatable() {
  ...
  let id = fixture.base.require_type_alias("Identity");
  assert_eq!(
    "setmetatable<{  }, { __index: {  } }>",
    to_string_type_id_to_string_options_mut(id, ToStringOptions::new(true))
  );
  let mt = get_type::get::<MetatableType>(id)
...
fn type_function_setmetatable_type_function_assigns_correct_metatable_2() {
  ...
  let mt = get_type::get::<MetatableType>(id).unwrap_or_else(|| {
    panic!(
  ...
  let foobar = fixture.base.require_type_alias("FooBar");
  let mt2 = get_type::get::<MetatableType>(foobar).unwrap_or_else(|| {
    panic!(
...
fn type_function_setmetatable_type_function_errors_on_metatable_with_metatable_metamethod() {
  ...
  let id = fixture.base.require_type_alias("Identity");
  assert_eq!(
    "setmetatable<{  }, { __metatable: \"blocked\" }>",
    to_string_type_id_to_string_options_mut(id, ToStringOptions::new(true))
  );
  let mt = get_type::get::<MetatableType>(id)
    .unwrap_or_else(|| panic!("expected MetatableType, got {}", to_string_type_id(id)));
...
fn type_function_type_functions_can_be_shadowed() {
  ...
  assert_eq!(
    "(string) -> string",
    to_string_type_id(fixture.base.require_type_string("hi"))
  );
  assert_eq!(
    "<a, b>(a, b) -> add<a, b>",
    to_string_type_id(fixture.base.require_type_string("plus"))
  );
}
...
fn type_function_vector_2_multiply_is_overloaded() {
  ...
  assert_eq!(
    "Vector2",
    to_string_type_id(fixture.base.base.require_type_string("v2"))
  );
  assert_eq!(
    "Vector2",
    to_string_type_id(fixture.base.base.require_type_string("v3"))
  );
  assert_eq!(
    "mul<Vector2, string>",
    to_string_type_id(fixture.base.base.require_type_string("v4"))
  );
}
...
// Source: `tests/TypeFunction.test.cpp:672`
#[test]
fn type_function_vector2_multiply_is_overloaded() {
  use ulua_analysis::functions::to_string_to_string::to_string_type_id;
  use ulua_common::fflag;
  use ulua_unit_test::records::extern_type_fixture::ExternTypeFixture;
...
// 缺口（未移植，对照 `tests/TypeFunction.test.cpp`，共 4 例）：
// - exporting_erroneous_type_function_is_error_type（:2102）——依赖 FFlag
//   `LuauCloneTypeFunctionFromForeignArena`，ulua 未同步。
// - oss_negation_of_nontestable_type_doesnt_crash_1（:2134）、
//   oss_2634_negation_of_nontestable_type_doesnt_crash_2（:2153）、
//   oss_2634_negation_of_nontestable_type_doesnt_crash_3（:2173）——依赖 FFlag
//   `LuauNormalizeGuardAgainstNonTestableNegations`（未同步）+
//   `NormalizationTooComplex` 报错路径。
