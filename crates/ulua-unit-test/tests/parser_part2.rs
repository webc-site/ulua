...
fn parser_error_const_not_initialized() {
  ...
  let mut fixture = Fixture::default();
  fixture.match_parse_error("const c", "Missing initializer in const declaration", None);
...
fn parser_export_is_an_identifier_only_when_followed_by_type() {
  ...
  let result = fixture.try_parse("export function a() end", &ParseOptions::new());
...
fn parser_export_value_parse_edge_cases() {
  ...
  fixture.parse("export local x = 5", &ParseOptions::default());
  fixture.parse("export const x = 5", &ParseOptions::default());
  fixture.parse("export function foo()\nend", &ParseOptions::default());
...
fn parser_export_value_rfc() {
  use ulua_ast::records::{
    ...
    ast_stat_local_function::AstStatLocalFunction, parse_options::ParseOptions,
  };
  use ulua_common::fflag::LuauExportValueSyntax;
  use ulua_unit_test::{records::fixture::Fixture, type_aliases::scoped_fast_flag::ScopedFastFlag};
...
fn parser_generic_function_declaration_parsing() {
  ...
  let mut fixture = Fixture::default();
  let result = fixture.parse_ex("declare function f<a, b, c...>()", &ParseOptions::default());
