...
use core::{ffi::c_int, ptr::addr_of_mut, sync::atomic::Ordering};
use std::thread;

use ulua_vm::{functions::lua_clock::lua_clock, type_aliases::lua_state::lua_State};
