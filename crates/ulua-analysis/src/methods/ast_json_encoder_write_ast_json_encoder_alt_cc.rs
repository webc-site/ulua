...
use ulua_ast::records::{ast_node::AstNode, ast_type_intersection::AstTypeIntersection};
...
impl AstJsonEncoder {
  ...
  pub unsafe fn write_ast_type_intersection(&mut self, node: *mut AstTypeIntersection) {
    let n = unsafe { &*node };
