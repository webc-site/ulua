...
use crate::{
  ...
  records::{constraint_generator::ConstraintGenerator, def_registry::def_ref, symbol::Symbol},
...
impl ConstraintGenerator {
  pub fn inherit_shared_refinements(
    ...
    let left_raw = arc_as_mut(left_scope);
    let right_raw = arc_as_mut(right_scope);
