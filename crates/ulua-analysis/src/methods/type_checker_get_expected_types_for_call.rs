...
use crate::{
  functions::{
    flatten_type_pack::flatten_type_pack_id, follow_type_pack, get_type, get_type_pack,
...
impl TypeChecker {
  pub fn get_expected_types_for_call(
    ...
    let mut demoter = Demoter::new(self.normalizer.arena_handle(), self.builtin_types);
