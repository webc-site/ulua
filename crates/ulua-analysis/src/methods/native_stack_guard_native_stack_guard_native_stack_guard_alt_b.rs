...
impl NativeStackGuard {
  pub fn native_stack_guard(&mut self) {
    ...
    #[cfg(target_os = "linux")]
    {
      unsafe extern "C" {
        fn pthread_self() -> *mut c_void;
        fn pthread_getattr_np(thread: *mut c_void, attr: *mut c_void) -> core::ffi::c_int;
        fn pthread_attr_getstack(
          attr: *const c_void,
          stackaddr: *mut *mut c_void,
          stacksize: *mut usize,
        ) -> core::ffi::c_int;
        fn pthread_attr_destroy(attr: *mut c_void) -> core::ffi::c_int;
      }
      ...
      unsafe {
        ...
        let attr_ptr = &mut attr as *mut AttrBuf as *mut c_void;
