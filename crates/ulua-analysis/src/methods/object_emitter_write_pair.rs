...
//!   - `Option<T>`                            -> functions/write_json_emitter.rs
//!   - `unordered_map<String, T>` / hash maps -> functions/write_json_emitter.rs

use ulua_ast::records::location::Location;

use crate::{
  functions::write_dcr_logger::{
    write_json_emitter_annotation_types_at_location, write_json_emitter_binding_snapshot,
    write_json_emitter_boundary_snapshot, write_json_emitter_constraint_block,
    write_json_emitter_constraint_generation_log, write_json_emitter_constraint_snapshot,
    write_json_emitter_error_snapshot, write_json_emitter_expr_types_at_location,
    write_json_emitter_location, write_json_emitter_scope_snapshot,
    write_json_emitter_step_snapshot, write_json_emitter_type_binding_snapshot,
    write_json_emitter_type_check_log, write_json_emitter_type_solve_log,
  },
  records::{
