...
use crate::{
  ...
  records::{sym_def::SymDef, symbol::Symbol},
...
pub struct Block {
  ...
  pub(crate) reaching_definitions: DenseHashMap<Symbol, *mut SymDef>,
}
...
impl Block {
  ...
  pub fn get_reaching_definition(&self, sym: Symbol) -> *mut SymDef {
  ...
  pub fn set_reaching_definition(&mut self, sym: Symbol, def: *mut SymDef) {
