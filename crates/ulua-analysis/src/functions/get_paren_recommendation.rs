...
use crate::{
  ...
  functions::{
    follow_type, get_paren_recommendation_for_func::get_paren_recommendation_for_func,
    get_paren_recommendation_for_intersect::get_paren_recommendation_for_intersect, get_type,
  },
...
pub fn get_paren_recommendation(
  ...
  if let Some(func) = get_type::get::<FunctionType>(id) {
    return get_paren_recommendation_for_func(func, nodes);
  }

  if let Some(intersect) = get_type::get::<IntersectionType>(id) {
