...
create_primordial!(
  /// 对应 C++ 原生 `static int createString(lua_State* L)`（`cpp/Analysis/src/TypeFunctionRuntime.cpp:516`）。
  create_string,
  TypeFunctionTypeVariant::Primitive(TypeFunctionPrimitiveType::new(Type::String))
);
