...
use crate::{
  functions::get_mutable_type_pack,
  records::{
    arena_id::ArenaId, free_type_pack::FreeTypePack, type_pack::TypePack,
    type_pack_var::TypePackVar, unifier::Unifier,
  },
...
pub(crate) fn queue_type_pack(
  ...
  loop {
    ...
    if get_mutable_type_pack::get_mutable::<FreeTypePack>(a).is_some() {
    ...
    } else if let Some(tp) = get_mutable_type_pack::get_mutable::<TypePack>(a) {
