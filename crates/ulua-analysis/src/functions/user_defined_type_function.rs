...
use ulua_ast::records::{ast_name::AstName, ast_stat_type_function::AstStatTypeFunction};
use ulua_common::{
  FFlag,
...
pub fn user_defined_type_function(
  ...
  unsafe {
    ...
    if FFlag::LuauTypeFunctionStructuredErrors.get() {
      ...
      LUAU_ASSERT!(runtime_builder.errors.is_empty());
      ...
      LUAU_ASSERT!(runtime_builder.errors_deprecated.is_empty());
