...
/// 类型运行期数据。对应 C++ 原生 `static int setTableReadIndexer(lua_State* L)`（`cpp/Analysis/src/TypeFunctionRuntime.cpp:1114`）。
pub unsafe fn set_table_read_indexer(l: *mut LuaState) -> i32 {
