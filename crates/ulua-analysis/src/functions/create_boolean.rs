...
create_primordial!(
  /// 对应 C++ 原生 `static int createBoolean(lua_State* L)`（`cpp/Analysis/src/TypeFunctionRuntime.cpp:489`）。
  create_boolean,
  TypeFunctionTypeVariant::Primitive(TypeFunctionPrimitiveType::new(Type::Boolean))
);
