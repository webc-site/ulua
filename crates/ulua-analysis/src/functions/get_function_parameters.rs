...
/// 类型运行期数据。对应 C++ 原生 `static int getFunctionParameters(lua_State* L)`（`cpp/Analysis/src/TypeFunctionRuntime.cpp:1384`）。
pub unsafe fn get_function_parameters(l: *mut LuaState) -> i32 {
