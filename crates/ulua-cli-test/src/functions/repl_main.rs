...
use crate::{
  functions::{run_file::run_file, setup_state::setup_state},
...
pub fn repl_main(args: &[impl AsRef<str>]) -> i32 {
  ...
  let mut program_args: Option<usize> = None;
  ...
  let prg_args: Vec<String> = args[program_args.unwrap_or(args.len())..]
    .iter()
