...
use crate::{
  ...
  functions::{
    ...
    get_module_path::get_module_path, normalize_path::normalize_path, path_string::into_string,
  },
...
impl VfsNavigator {
  pub fn reset_to_std_in(&mut self) -> NavigationStatus {
    ...
    self.absolute_module_path = into_string(get_module_path(Path::new(&self.absolute_real_path)));
