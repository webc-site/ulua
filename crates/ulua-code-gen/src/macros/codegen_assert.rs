//! Source: `CodeGen/include/Luau/CodeGenCommon.h:CODEGEN_ASSERT` (hand-fixed: the
//! original translation passed `&str` where the handler takes `*const c_char` and
//! could never have expanded; mirrors LUAU_ASSERT!)
