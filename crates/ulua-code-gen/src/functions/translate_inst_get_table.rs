...
pub unsafe fn translate_inst_get_table(build: &mut IrBuilder, pc: *const Instruction, pcpos: i32) {
  let insn = unsafe { *pc };
    ...
    || bc_types.b == LuauBytecodeType::LBC_TYPE_STRING.0 as u8
  {
    ...
    build.inst_ir_cmd_ir_op_ir_op_ir_op(IrCmd::GetTable, reg_ra, reg_rb, reg_rc);
    return;
  }
