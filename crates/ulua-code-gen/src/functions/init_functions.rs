...
use crate::records::{
  ...
  native_fn::{
    ...
    FORG_PREP_XNEXT_FALLBACK, GET_IMPORT, LIBM_ACOS, LIBM_ASIN, LIBM_ATAN, LIBM_ATAN2, LIBM_COS,
    LIBM_COSH, LIBM_EXP, LIBM_FMOD, LIBM_FREXP, LIBM_LDEXP, LIBM_LOG, LIBM_LOG2, LIBM_LOG10,
    LIBM_MODF, LIBM_POW, LIBM_ROUND, LIBM_SIN, LIBM_SINH, LIBM_TAN, LIBM_TANH, LUA_C_BARRIERBACK,
    LUA_C_BARRIERF, LUA_C_BARRIERTABLE, LUA_C_STEP, LUA_F_CLOSE, LUA_F_FINDUPVAL,
    LUA_F_NEW_LCLOSURE, LUA_H_CLONE, LUA_H_GETN, LUA_H_NEW, LUA_H_RESIZEARRAY, LUA_H_SETNUM,
    LUA_T_GETTM, LUA_T_OBJTYPENAMESTR, LUA_V_CONCAT, LUA_V_DOARITH_ADD, LUA_V_DOARITH_DIV,
    LUA_V_DOARITH_IDIV, LUA_V_DOARITH_MOD, LUA_V_DOARITH_MUL, LUA_V_DOARITH_POW, LUA_V_DOARITH_SUB,
    LUA_V_DOARITH_UNM, LUA_V_DOLEN, LUA_V_EQUALVAL, LUA_V_GETTABLE, LUA_V_LESSEQUAL,
    LUA_V_LESSTHAN, LUA_V_SETTABLE, NEW_USERDATA,
  },
};
