...
use crate::{
  ...
  functions::{
    ...
    load_double_or_constant::load_double_or_constant, tm_to_host_metamethod::tm_to_host_metamethod,
...
pub fn translate_inst_binary_numeric(
  ...
  if is_userdata_bytecode_type(bc_types.a) || is_userdata_bytecode_type(bc_types.b) {
    // cpp IrTranslation.cpp:866-869：先尝试宿主 userdata 元方法展开，未接管再走 DO_ARITH
