...
pub fn emit_return_assembly_builder_a_64_module_helpers(
  ...
  build.ldr(X0, mem(R_STATE, offset_of!(LuaState, ci) as i32));
  ...
  build.str(X2, mem(R_STATE, offset_of!(LuaState, ci) as i32));
  build.ldr(R_BASE, mem(X2, offset_of!(CallInfo, base) as i32));
  build.str(R_BASE, mem(R_STATE, offset_of!(LuaState, base) as i32));

  build.str(X1, mem(R_STATE, offset_of!(LuaState, top) as i32));
