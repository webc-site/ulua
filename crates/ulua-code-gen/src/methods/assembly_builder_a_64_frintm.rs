...
impl AssemblyBuilderA64 {
  pub fn frintm(&mut self, dst: RegisterA64, src: RegisterA64) {
    ...
    if dst.kind() == KindA64::Q {
      self.place_r_1("frintm", dst, src, 0b01_0011_1000_1000_0110_0110);
    } else if dst.kind() == KindA64::D {
      self.place_r_1("frintm", dst, src, 0b00_0111_1001_1001_0101_0000);
    } else {
      self.place_r_1("frintm", dst, src, 0b00_0111_1000_1001_0101_0000);
    }
  }
}
