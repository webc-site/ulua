...
use crate::{
  ...
  macros::{
    ...
    gc_spropagate::GCSPROPAGATE, gco_2_cl::gco2cl, gco_2_class::gco2class, gco_2_h::gco2h,
    gco_2_object::gco2object, gco_2_p::gco2p, gco_2_th::gco2th, gray_2_black::gray2black,
    isgray::isgray, size_cclosure::size_cclosure, size_lclosure::size_lclosure, sizenode::sizenode,
  },
  records::{
