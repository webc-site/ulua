...
/// # Safety
/// 传入的指针必须有效且指向存活对象，调用方须满足 C++ 参考实现的前置条件。
#[cfg_attr(feature = "capi", unsafe(export_name = "ulua_luaV_doarithimpl_TM_ADD"))]
...
#[cfg_attr(feature = "capi", unsafe(export_name = "ulua_luaV_doarithimpl_TM_SUB"))]
/// # Safety
/// 传入的指针必须有效且指向存活对象。
...
#[cfg_attr(feature = "capi", unsafe(export_name = "ulua_luaV_doarithimpl_TM_MUL"))]
/// # Safety
/// 传入的指针必须有效且指向存活对象。
...
#[cfg_attr(feature = "capi", unsafe(export_name = "ulua_luaV_doarithimpl_TM_DIV"))]
/// # Safety
/// 传入的指针必须有效且指向存活对象。
...
#[cfg_attr(feature = "capi", unsafe(export_name = "ulua_luaV_doarithimpl_TM_MOD"))]
/// # Safety
/// 传入的指针必须有效且指向存活对象。
...
#[cfg_attr(feature = "capi", unsafe(export_name = "ulua_luaV_doarithimpl_TM_POW"))]
/// # Safety
/// 传入的指针必须有效且指向存活对象。
...
#[cfg_attr(feature = "capi", unsafe(export_name = "ulua_luaV_doarithimpl_TM_UNM"))]
/// # Safety
/// 传入的指针必须有效且指向存活对象。
