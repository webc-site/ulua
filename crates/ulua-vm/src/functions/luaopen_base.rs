...
use crate::{
  functions::{
    ...
    lua_b_getmetatable::lua_b_getmetatable, lua_b_inext::lua_b_inext_arm,
    ...
    lua_b_setfenv::lua_b_setfenv, lua_b_setmetatable::lua_b_setmetatable,
    lua_b_tonumber::lua_b_tonumber, lua_b_tostring::lua_b_tostring, lua_b_type::lua_b_type,
    lua_b_typeof::lua_b_typeof, lua_b_xpcallcont::lua_b_xpcallcont, lua_b_xpcally::lua_b_xpcally,
...
static BASE_FUNCS: [LuaLReg; 19] = [
  ...
  LuaLReg::new(b"getmetatable", lua_b_getmetatable),
