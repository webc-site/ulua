...
use crate::{
  ...
  records::{global_state::global_State, lua_page::lua_Page},
  type_aliases::{gc_visitor::GcVisitor, lua_state::lua_State},
};

/// # Safety
/// 传入的指针必须有效且指向存活对象，调用方须满足 C++ 参考实现的前置条件。
pub unsafe fn lua_m_visitgco(l: *mut lua_State, context: *mut c_void, visitor: GcVisitor) {
  unsafe {
