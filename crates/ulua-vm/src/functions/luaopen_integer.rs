use crate::{
  functions::{
    int_64_add::int64_add, int_64_arshift::int64_arshift_arm, int_64_band::int64_band,
    int_64_bnot::int64_bnot, int_64_bor::int64_bor, int_64_bswap::int64_bswap,
    int_64_btest::int64_btest_arm, int_64_bxor::int64_bxor, int_64_clamp::int64_clamp_arm,
    int_64_countlz::int64_countlz, int_64_countrz::int64_countrz, int_64_create::int64_create_arm,
    int_64_div::int64_div, int_64_extract::int64_extract_arm,
    int_64_fromstring::int64_fromstring_arm, int_64_ge::int64_ge, int_64_gt::int64_gt,
    int_64_idiv::int64_idiv, int_64_le::int64_le, int_64_lrotate::int64_lrotate,
    int_64_lshift::int64_lshift, int_64_lt::int64_lt, int_64_max::int64_max, int_64_min::int64_min,
    int_64_mod::int64_mod, int_64_mul::int64_mul, int_64_neg::int64_neg, int_64_rem::int64_rem,
    int_64_replace::int64_replace_arm, int_64_rrotate::int64_rrotate, int_64_rshift::int64_rshift,
    int_64_sub::int64_sub, int_64_tonumber::int64_tonumber_arm, int_64_udiv::int64_udiv,
    int_64_uge::int64_uge, int_64_ugt::int64_ugt, int_64_ule::int64_ule, int_64_ult::int64_ult,
...
static INT64LIB: [LuaLReg; 39] = [
  ...
  LuaLReg::new(b"tonumber", int64_tonumber_arm),
  ...
  LuaLReg::new(b"clamp", int64_clamp_arm),
  ...
  LuaLReg::new(b"arshift", int64_arshift_arm),
  LuaLReg::new(b"lrotate", int64_lrotate),
  LuaLReg::new(b"rrotate", int64_rrotate),
  LuaLReg::new(b"extract", int64_extract_arm),
  LuaLReg::new(b"replace", int64_replace_arm),
  LuaLReg::new(b"btest", int64_btest_arm),
  LuaLReg::new(b"countrz", int64_countrz),
  LuaLReg::new(b"countlz", int64_countlz),
  LuaLReg::new(b"bswap", int64_bswap),
  LuaLReg::new(b"fromstring", int64_fromstring_arm),
];
