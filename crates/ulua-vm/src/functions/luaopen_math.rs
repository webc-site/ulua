...
static MATH_FUNCS: [LuaLReg; 37] = [
  ...
  LuaLReg::new(b"frexp", math_frexp),
  LuaLReg::new(b"ldexp", math_ldexp),
  LuaLReg::new(b"log10", math_log_10),
  LuaLReg::new(b"log", math_log),
  LuaLReg::new(b"max", math_max),
  LuaLReg::new(b"min", math_min),
  LuaLReg::new(b"modf", math_modf),
  LuaLReg::new(b"pow", math_pow),
  LuaLReg::new(b"rad", math_rad),
  LuaLReg::new(b"random", math_random),
  LuaLReg::new(b"randomseed", math_randomseed),
  ...
  LuaLReg::new(b"noise", math_noise),
  LuaLReg::new(b"clamp", math_clamp),
  LuaLReg::new(b"sign", math_sign),
  LuaLReg::new(b"round", math_round),
  LuaLReg::new(b"map", math_map),
  LuaLReg::new(b"lerp", math_lerp),
