...
/// # Safety
///
/// `l` 须为有效存活的 `lua_State`，`index1`/`index2` 须为栈内有效索引。
#[cfg_attr(feature = "capi", unsafe(export_name = "ulua_lua_lessthan"))]
pub unsafe fn lua_lessthan(l: *mut lua_State, index1: c_int, index2: c_int) -> c_int {
  unsafe {
