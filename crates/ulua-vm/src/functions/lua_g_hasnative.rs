...
/// # Safety
///
/// `l` 须为有效存活的 `lua_State`，`level` 须指向当前调用栈内的活动层。
#[cfg_attr(feature = "capi", unsafe(export_name = "ulua_lua_g_hasnative"))]
pub unsafe fn lua_g_hasnative(l: *mut lua_State, level: c_int) -> c_int {
  unsafe {
