...
"#,
  ...
  let actual = unsafe { fixture.get_codegen_assembly(source.as_ptr(), false, 1, 2, false) };
...
"#,
  ...
  let actual = unsafe { fixture.get_codegen_assembly(source.as_ptr(), false, 1, 1, false) };
  assert!(!actual.is_empty());
}
...
"#,
  ...
  let assembly = unsafe { fixture.get_codegen_assembly(source.as_ptr(), false, 1, 2, false) };
