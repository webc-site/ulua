...
use crate::{
  enums::global::Global, functions::get_global_state::get_global_state, records::compiler::Compiler,
};

impl Compiler {
  /// # Safety
  /// 传入的指针必须有效且指向存活对象，调用方须满足 C++ 参考实现的前置条件。
  pub unsafe fn can_import_chain(&self, expr: *mut AstExprGlobal) -> bool {
