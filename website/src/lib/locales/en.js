export default {
  "meta.title": "ulua — Luau Rewritten in Rust",
  "meta.description":
    "Luau VM, compiler, and static type checker rewritten in Rust. Runs in the browser via WebAssembly.",
  "nav.playground": "Playground",
  "nav.benchmark": "Benchmarks",
  "nav.about": "About Luau",
  "nav.features": "WASM Target",
  "nav.lua_syntax": "Lua 5.1 Syntax",
  "nav.luau_syntax": "Luau Extensions",
  "nav.embed": "Rust Embed",
  "nav.checker": "Type Checker",
  "nav.crates": "Crates",
  "nav.lang": "中文",
  ...
  "hero.title_pre": "Rewrite Luau,",
  "hero.title_grad": "in Pure Rust",
  "pg.example": "Examples",
  "pg.run": "Run",
  "pg.check": "Typecheck",
  "pg.clear": "Clear",
  "pg.editor_tab": "source.luau",
  "pg.diag_output": "Diagnostics & Output",
  "pg.loading_engine": "Loading Luau engine (WebAssembly)…",
  "pg.ready_prompt":
    'Engine ready. Click "Run" (Ctrl+Enter) to execute, or edit code for instant type checking.',
  "pg.note":
  ...
  "about.title": "What is Luau? Why Rewrite in Rust",
  "about.lead":
  ...
  "features.title": "Compile to WebAssembly",
  "features.desc":
  ...
  "syntax.expand_all": "Expand All",
  "syntax.collapse_all": "Collapse All",
  ...
  "syntax.lua_basics": "Variables, Scope & Primitives",
  ...
  "syntax.lua_control": "Control Flow & Iteration",
  ...
  "syntax.lua_functions": "Functions & Lexical Closures",
  ...
  "syntax.lua_tables": "Tables, Metatables & OOP",
  ...
  "syntax.lua_coroutines": "Cooperative Multitasking & Coroutines",
  ...
  "syntax.luau_syntax": "Modern Ergonomic Syntax",
  ...
  "syntax.luau_types": "Gradual Static Type System",
  ...
  "syntax.luau_tables": "Structural Table Types & States",
  ...
  "syntax.luau_generics": "Generics & Type Packs",
  ...
  "syntax.luau_host": "OOP & Modular Architecture",
  ...
  "syntax.luau_native": "Native Performance & Metaprogramming",
  ...
  "status.ran_ok": "Ran ok",
  "status.errors": "error(s)",
  "out.no_errors": "No type errors found.",
  "out.no_output": "(No output — script produced no print calls)",
